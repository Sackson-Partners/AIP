...
const navigation = [
  ...
  { name: 'PIS', href: '/dashboard/pis', icon: FileIcon },
  { name: 'PETFEL', href: '/dashboard/petfel', icon: ClipboardIcon },
  { name: 'EIN', href: '/dashboard/ein', icon: DocumentTextIcon },
  ...
  { name: 'Integrations', href: '/dashboard/integrations', icon: PuzzleIcon },
];
