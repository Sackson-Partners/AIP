    ...
    <div className="space-y-8 max-w-6xl">
      ...
      <div className="bg-yellow-900/30 border border-yellow-700/50 rounded-xl p-5">
        ...
        <ul className="text-sm text-yellow-200/80 space-y-1 list-disc list-inside">
          <li>Auth → URL Configuration → Site URL set to <code className="text-yellow-100">https://www.app.africa-infra.com</code></li>
          <li>Auth → URL Configuration → Redirect URLs includes <code className="text-yellow-100">https://www.app.africa-infra.com/auth/callback</code></li>
