...
const LEGACY_ALIASES: Record<string, Permission> = {
  ...
  // Sidebar permission names (old API)
  ...
  view_pipeline:           "view_projects",
  move_pipeline:           "edit_project",
  vote_ic:                 "approve_project",
  manage_ic:               "manage_users",
  upload_documents:        "create_deal_room",
  upload_own_documents:    "view_deal_room",
